...
- 💬 **Intelligent Question Answering** - An AI-based fashion design question-and-answer system
- 🏪 **Supplier Management** - Supplier inquiries and map display
...
```
AtelierX/
├── n8n的前端/           # Front-end pages
│   ├── 主页.html        # Main page
│   ├── 个人.html        # Personal center
│   ├── 供货商.html      # Supplier page
│   ├── 打版分析.html    # Garment analysis page
│   ├── 灵感来源.html    # Inspiration source page
│   └── 设计图/          # Design resources
